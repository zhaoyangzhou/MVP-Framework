...
public interface ITouchable {
	...
	/**
	 * Method: onLongPressDown
	 * Description: 扩展:长按按下
	 * @param
	 * @return  void
	 */
	void onLongPressDown(PointF pt);
	/**
	 * Method: onLongPressMoved
	 * Description: 扩展:长按移动
	 * @param
	 * @return  void
	 */
	void onLongPressMoved(PointF pt);
	/**
	 * Method: onLongPressUp
	 * Description: 扩展:长按抬起
	 * @param
	 * @return  void
	 */
	void onLongPressUp(PointF pt);
