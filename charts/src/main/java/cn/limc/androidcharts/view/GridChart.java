...
//	}
	...
	@Override
	public void onLongPressDown(PointF pt) {
		displayCross();
		this.touchPoint = pt;
		this.postInvalidate();
	}
	...
	@Override
	public void onLongPressMoved(PointF pt) {
		this.touchPoint = pt;
		this.postInvalidate();
	}

	@Override
	public void onLongPressUp(PointF pt) {
		dismissCross();
		this.touchPoint = pt;
		this.postInvalidate();
	}
